...
const PopularTopics: React.FC<{
  ...
  return (
    <div className="p-6" data-aos="fade-up" data-aos-duration="800">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl mobile-l:text-3xl font-semibold mb-6" data-aos="fade-right" data-aos-delay="100">
          📚 Popular Topics
        </h2>
          ...
          {popularTopics.map((topic, idx) => (
            ...
            >
              <div>
                ...
                <button className="text-sm mt-2 bg-blue-500 group-hover:bg-blue-600 px-4 py-2 rounded text-white flex items-center justify-center gap-2 cursor-pointer">
                  Explore Tests <ArrowRight className="group-hover:translate-x-1 h-3 w-3" />
                </button>
              </div>
            </Link>
          ))}
