      ...
      <header className="relative bg-blue-500 w-full flex flex-col-reverse tablet:flex-row items-center justify-around gap-14 px-6 py-10 pb-20 overflow-hidden">
        ...
        >
          ...
          <ul className="text-white/90 text-lg space-y-1 list-disc list-inside text-left md:text-left px-4">
            <li>
              Click <strong>Next</strong> button for the next question.
            </li>
            <li>
              Click <strong>Prev</strong> button to go back to the previous
              question.
            </li>
            <li>
        ...
        >
          ...
          <img
            src={GoodLuckImg}
            alt="All The Best"
            className="w-full tablet:h-[40vh] object-cover drop-shadow-2xl rounded-xl  relative z-20"
          />
        </div>
      </header>
      {/* Bottom Wave */}
